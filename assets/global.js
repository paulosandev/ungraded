...
// Sistema de búsqueda expandible
class ExpandableSearch {
  constructor() {
    this.searchToggle = document.querySelector('.search-toggle-btn');
    this.searchContainer = document.querySelector('.search-bar-container');
    this.searchInput = document.querySelector('.search-input');
    this.searchClose = document.querySelector('.search-close-btn');
  ...
  init() {
    ...
    document.addEventListener('click', (e) => {
      if (this.isSearchActive && !this.searchContainer.contains(e.target) && !this.searchToggle.contains(e.target)) {
        this.closeSearch();
      }
    });
  ...
  openSearch() {
    ...
    this.siteHeader?.classList.add('search-active');
    this.searchContainer?.classList.add('search-bar-active');
  ...
  closeSearch() {
    ...
    this.isSearchActive = false;
    this.siteHeader?.classList.remove('search-active');
    this.searchContainer?.classList.remove('search-bar-active');
...
// Inicializar búsqueda expandible cuando el DOM esté listo
document.addEventListener('DOMContentLoaded', () => {
  new ExpandableSearch();
});

// Sistema de menú hamburguesa móvil
class MobileMenu {
  constructor() {
  ...
  init() {
    if (!this.toggle || !this.navigation) return;
  ...
  openMenu() {
    ...
    this.navigation?.classList.add('mobile-nav-open');
  ...
  closeMenu() {
    ...
    this.navigation?.classList.remove('mobile-nav-open');
